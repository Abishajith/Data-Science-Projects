...
### Evaluation similar to prediction so validation included
...
###  evaluate both train and test data set thats why doing concat, to do acccuracy of complete data 
